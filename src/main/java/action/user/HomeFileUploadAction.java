...
public class HomeFileUploadAction extends ActionSupport implements ServletContextAware   {  
    /**
	 * 
	 */
...
public void setUploadError(String uploadError) {
	...
	public String execute(){  
    	...
    	String targetDirectory=context.getRealPath(File.separator+"images");
