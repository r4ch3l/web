...
public class EmailUtil {
	...
	static {
		...
		InputStream in = loader.getResourceAsStream("util" + File.separator
				+ "mailcfg.properties");
	...
	public static void sendEmail(String address, Feedback feedback) {
		try {
		Date a = new Date(feedback.getSubmitTime());
		DateFormat fmt = new SimpleDateFormat(dateformat);
		String str = "Hi,\n\n"
			+ "New feeback submited from your website www.xxx.com : \n\n"
			+ feedback.getMessage() + "\n\nName : "
